...
const playgroudPageStr = `<!DOCTYPE html>
<html>
<head>
	<meta charset=utf-8/>
...
func playground(title, endpoint string) httprouter.Handle {
	playgroudPage := template.Must(template.New("graphiql").Parse(playgroudPageStr))
