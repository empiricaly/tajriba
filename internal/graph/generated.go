...
func (ec *executionContext) unmarshalInputAddScopeInput(ctx context.Context, obj interface{}) (mgen.AddScopeInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "attributes":
			...
			data, err := ec.unmarshalOSetAttributeInput2ᚕᚖgithubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋgraphᚋmgenᚐSetAttributeInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.Attributes = data
...
func (ec *executionContext) unmarshalInputOnEventInput(ctx context.Context, obj interface{}) (mgen.OnEventInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "eventTypes":
			...
			data, err := ec.unmarshalNEventType2ᚕgithubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋgraphᚋmgenᚐEventTypeᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.EventTypes = data
...
func (ec *executionContext) unmarshalInputScopedAttributesInput(ctx context.Context, obj interface{}) (models.ScopedAttributesInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "kvs":
			...
			data, err := ec.unmarshalOKV2ᚕᚖgithubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋmodelsᚐKVᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.KVs = data
...
func (ec *executionContext) unmarshalInputStepOrder(ctx context.Context, obj interface{}) (mgen.StepOrder, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "direction":
			...
			data, err := ec.unmarshalNOrderDirection2githubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋgraphᚋmgenᚐOrderDirection(ctx, v)
			if err != nil {
				return it, err
			}
			it.Direction = data
		case "field":
			...
			data, err := ec.unmarshalOStepOrderField2ᚖgithubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋgraphᚋmgenᚐStepOrderField(ctx, v)
			if err != nil {
				return it, err
			}
			it.Field = data
...
func (ec *executionContext) unmarshalInputTransitionInput(ctx context.Context, obj interface{}) (mgen.TransitionInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "from":
			...
			data, err := ec.unmarshalNState2githubᚗcomᚋempiricalyᚋtajribaᚋinternalᚋmodelsᚐState(ctx, v)
			if err != nil {
				return it, err
			}
			it.From = data
